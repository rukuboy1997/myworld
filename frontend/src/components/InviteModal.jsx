...
const INVITE_TEXT =
  "Join me on myWorld — the Sui-native social network for athletes & creators. Connect, share, and own your content on-chain!";
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(INVITE_TEXT)}&url=${encodeURIComponent(APP_URL)}`}
                target="_blank"
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent(INVITE_TEXT + " " + APP_URL)}`}
                target="_blank"
                rel="noopener noreferrer"
