      ...
      <div className="w-full max-w-md glass-panel border border-white/10 rounded-3xl p-8 text-center flex flex-col items-center gap-5">
          ...
          <>
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Your email has been confirmed. Your account is now fully
                secured.
              </p>
            </div>
            <Link
              to="/feed"
              className="bg-primary text-primary-foreground px-6 py-3 rounded-full font-bold hover:bg-primary/90 transition-colors text-sm"
            >
              Go to Feed
            </Link>
          </>
        ...
        {status === "error" && (
          <>
            ...
            <Link
              to="/feed"
              className="bg-secondary border border-white/10 px-6 py-3 rounded-full font-bold hover:bg-secondary/80 transition-colors text-sm"
            >
              Go to Feed
            </Link>
          </>
