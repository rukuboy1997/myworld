  ...
  if (n.type === "comment")
    return (
      <>
        ...
        <span className="text-muted-foreground">"{n.excerpt}"</span>
      </>
    );
  if (n.type === "follow")
    return (
        ...
        {isLoading ? (
          <div className="flex flex-col gap-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="glass-panel rounded-2xl h-16 animate-pulse"
              />
            ))}
          </div>
          ...
          <div className="flex flex-col gap-2">
            {notifications.map((n) => {
              ...
              const actorInitial = (n.actorProfile?.username || "?")
                .charAt(0)
                .toUpperCase();
              const linkTo =
                n.type === "message"
